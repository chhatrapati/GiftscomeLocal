...
;(function(window, document, plupload, o, $) {
    ...
    function renderUI(obj) {
        ...
        obj.html(
            ...
            '<div class="plupload_header_title">' + _("Preview") + '</div>' +
            '<div class="plupload_header_text hidden">' + _("") + '</div>' +
            ...
            '<div class="plupload_droptext hidden-xs">' + _("Drag files here.") + '</div>' +
            ...
            '<a class="plupload_button plupload_add theme-bg-color">' + _("Add Files") + '</a>&nbsp;' +
            '<a class="plupload_button plupload_start">' + _("Send") + '</a>&nbsp;' +
