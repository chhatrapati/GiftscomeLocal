		...
		<div class="topbar">
			...
			<div class="topbar-child2">
				...
				{ 
					...
					<span class="topbar-email" style="padding-right:10px;">
						Welcome, <?php echo htmlentities(@$_SESSION['username_1']);?> <span class="badge-pill badge-success"><?php echo $user_type;?></span>
					</span>
					<span class="topbar-email"  style="padding-right:10px;">
				...
				<div class="wrap_menu">
					<nav class="menu">
						<ul class="main_menu">
							...
							<li class="">
								<a href="support_us.php"  onclick="localStorage.clear();">SUPPORT</a>
							</li>
							<li class="">
			...
			<?php if(strlen(@$_SESSION['login'])==0) {   ?>
					...
					<li class="item-menu-mobile">
					 ...
					 <li class="item-menu-mobile">
						<a href="support_us.php" >SUPPORT</a>
					</li>
					<li class="item-menu-mobile">
