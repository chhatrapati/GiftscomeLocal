...
<?php } else { ?>
 ...
 <div class="row">
		        <div class="col-lg-10 col-sm-10 col-md-10 text-left">
					...
					<input class="m-text18 t-center num-product" type="number" pattern="[0-9]" name="coin_add" id="coin_add" value="5" maxlength="5" style="border:1px solid #000 !important; height: 100% !important;">
