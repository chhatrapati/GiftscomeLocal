...
<h2 class="l-text2 t-center">Friends</h2>
<p class="m-text13 t-center">New Arrivals Friends List</p>
</section>
				...
				<div class="col-sm-6 col-md-8 col-lg-9 p-b-50">
					<div class="row" id="productContainer">
                        ...
                        while ($rowFriend = mysqli_fetch_array($resultFriend, MYSQLI_BOTH)) {
                            echo $arrFriends[]=$rowFriend["sender_id"];
                        }
                        $arrFriends[]=$member_id;
                        //$query = "SELECT * FROM  users where id not in (".implode(",",$arrFriends).")";
						$query = "SELECT * FROM  users where id not in (SELECT myid FROM myfriends WHERE myfriends = '$member_id')";
...
<style>
#skills {width:350px;border:solid 1px #000;padding:3px;margin-top: 20px;margin-left:863px;}
#divResult {position:absolute;width:350px;display:none;border:solid 1px #dedede;border-top:0px;overflow:hidden;border-bottom-right-radius: 6px;border-bottom-left-radius: 6px;-moz-border-bottom-right-radius: 6px;-moz-border-bottom-left-radius: 6px;box-shadow: 0px 0px 5px #999;
border-width: 3px 1px 1px;border-style: solid;border-color: #333 #DEDEDE #DEDEDE;background-color: white;margin-left: 250px; margin-top: 50px;}
.contentArea{width:600px;margin:0 auto;}
