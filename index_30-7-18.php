...
<body class="animsition" onLoad="start()">
	<?php require_once('templates/header.php');?>
			...
			<section class="slider_img">
				...
				<p><?php echo SITE_URL;?>/register.php?ref=<?php echo $ref_code;?></p>
				<a href="whatsapp://send?text=<?php echo SITE_URL;?>/register.php?ref=<?php echo $ref_code;?>">Share on whatsapp</a>
				<a href="https://www.linkedin.com/shareArticle?mini=true&url=<?php echo SITE_URL;?>/register.php?ref=<?php echo $ref_code;?>" onclick="javascript:window.open(this.href, '', 'menubar=no,toolbar=no,resizable=yes,scrollbars=yes,height=300,width=600');return false;" target="_blank" title="Share on Linkedin"><i class="fa fa-linkedin"></i></a>
				 </div>									
