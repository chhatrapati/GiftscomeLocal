...
define( 'BASE_PATH', 'http://localhost/gclive/login.php');
define( 'DB_HOST', 'localhost' );
define( 'DB_USERNAME', 'root');
define( 'DB_PASSWORD', '');
define( 'DB_NAME', 'giftscome_live');


//Facebook App Details
define('FB_APP_ID', '482841608779740');
define('FB_APP_SECRET', '350adeb8e038cb0f34ff76e59457f629');
define('FB_REDIRECT_URI', 'http://localhost/gclive/login-account.php');
...
define('GOOGLE_OAUTH_REDIRECT_URI', 'http://localhost/gclive/login-account.php');
