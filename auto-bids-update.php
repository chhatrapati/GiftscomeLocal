...
$bids_by_user = mysqli_query($con,"SELECT * FROM tbl_userbids where game_id ='$expire_game_id' AND user_id ='$user_id'");
...
$prev_bet = $user_obj->total_bids_ongame_byuser($expire_game_id,$user_id);
if($prev_bet=='')
{
	$prev_bet='0';
}
...
$final_rem_gcoins = $avail_coins + $prev_bet - $total_pre_bids;
