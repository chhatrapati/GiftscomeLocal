			       			...
			       			{  
			            		$order_table .= '  
			                 	<tr class="table-row">
			                    	...
			                    	<td class="column-3"><img alt="Gift Coins" src="images/GiftCoin.png" class="top-icons" />'.$values["product_price"].'</td>  
	       			...
	       			foreach($_SESSION["shopping_cart"] as $keys => $values)  
	       			{
	            		...
	            		$order_table .= '  
	                 	<tr class="table-row">
	                    	...
	                    	<td class="column-3"><img alt="Gift Coins" src="images/GiftCoin.png" class="top-icons" />'.number_format($values["product_price"]).'</td>  
	                      	<td align="right">'.number_format($values["product_quantity"] * $values["product_price"]).' <button name="delete" class="btn btn-danger btn-xs delete" id="'.$values["product_id"].'"><i class="fa fa-remove"></i></button></td>  
