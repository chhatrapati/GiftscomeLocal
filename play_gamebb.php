...
<?php
			...
			$res_declare = date('Y-m-d H:i:s',strtotime('+30 seconds',strtotime($end_date)));
			$End_date_extend = date('Y-m-d H:i:s',strtotime('+15 minutes',strtotime($end_date)));
			//echo '<br/>Result Declare time is: '.$res_declare;
?>
<?php if($End_date_extend < $currentTime ) { ?>
			<!-- User Bids -->
<div class="container">
<div class="row">
	<!-- panel-heading -->
	...
	<div id="" class="col-md-12">
		...
		<div class="panel-body">
			<div class="row">		
				...
				<table id="example" class="table data-table custom-table table-striped dataTable"  cellspacing="0" width="100%">
					<thead>
						<tr>
...
<?php } else { ?>
	...
	<div class="" style="padding-bottom: 3px;">
		...
		<div class="col-lg-10 " style="padding-left:50px; ">
					...
					<input class="size8 m-text18 t-center num-product" type="number" pattern="[0-9]" name="coin_add" id="coin_add" value="5" maxlength="5" style="border:1px solid #000 !important;">
					<button class="btn-num-product-up btn btn-suc" id="plus<?php echo $row['payout_digit'];?>" onclick="todo()"><i class="fs-12 fa fa-plus" aria-hidden="true"></i></button>
				     <button type="button" class="btn btn-info bt" id="half" style="padding:0px 26px 0px 26px">x0.5</button> 
					 <button type="button" class="btn btn-info bt" id="onendhalf" style="padding:0px 26px 0px 26px">x1.5</button> 
					 <button type="button" class="btn btn-info bt" id="double" style="padding:0px 26px 0px 26px">x2</button> 
					 <button type="button" class="btn btn-info bt" id="five" style="padding:0px 26px 0px 26px">x5</button> 
			        <button type="button" class="btn btn-info bt" id="ten" style="padding:0px 26px 0px 26px">x10</button> 
				    <button type="button" class="btn btn-info bt" id="twentyfive" style="padding:0px 26px 0px 26px">x25</button> 
			        <button type="button" class="btn btn-info bt" id="hundered" style="padding:0px 26px 0px 26px">x100</button> 
				    <button type="button" class="btn btn-info bt" id="fivehund" style="padding:0px 26px 0px 26px">x500</button> 
					</div>
		</div>
				<div class="col-lg-2s ">
...
<div class="col-sm-12">
    <div class="row">
     ...
     <button type="button" class="btn btn-danger bt" name="even_no" id="even_no" value="EVEN">EVEN</button></div>
    <div class="col-lg-5 col-sm-5 col-md-5 text-left">
      ...
      <button type="button" class="btn btn-info bt" id="small_no">SMALL (00-13)</button>
        <button type="button" class="btn btn-info bt" id="big_no">BIG(14-27)</button></div>
        <div class="col-lg-2 col-sm-2 col-md-2 text-left">
     ...
     <?php }?><button type="button" class="btn btn-warning bt" id="reverse_no">REVERS BET</button>
    </div>
     <div class="col-lg-3 col-sm-3 col-md-3 text-right">
     <button type="button" id="clear" class="btn btn-warning bt">Clear All</button>
    <button type="button" id="subbtn" class="btn btn-success bt" style="margin-left: 10px;">Submit</button>  
    <button type="button" name="" id="cnl_btn" class="btn btn-danger bt" value="cancel" onClick="return confirm('Are you sure you want to cancel?')" style="margin-left: 10px;">Cancel</button>
   </div>
   </div>
   </div></br>
					<div class="row">
