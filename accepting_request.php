...
require_once('includes/config.php');
       ...
       $myfriend=$_POST['uid'];
		...
		$mfriends=mysqli_query($con,"INSERT INTO frineds(myid,myfriends) VALUES('$member_id','$myfriend') ")or die(mysql_error($con));
		
		$mfriends=mysqli_query($con,"INSERT INTO frineds(myid,myfriends) VALUES('$myfriend','$member_id') ")or die(mysql_error($con));
