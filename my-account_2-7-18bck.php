...
$payout_amount1 = $_POST['payout_amount7'];
$payout_amount7 = $_POST['payout_amount2'];
	...
	<div id="collapsesix" class="panel-collapse collapse">
		...
		<div class="widget-content nopadding" style="width=100%">
		  ...
		  <div class="controls" style="float:left; width:50%;margin-left:0px;">
			...
			<div class="controls">
            <input type="number" class="form-control unicase-form-control text-input"  pattern="[0-9]"  onkeypress="return AllowOnlyNumbers(event);" maxlength="5" name="payout_amount0" id="payout_amount0" placeholder="Enter Bid Amount" value="<?php if($bid_0) { echo $bid_0; } else {echo '1';}?>" />
			</div>
			<label class="label_digit digit_img">1</label>
			<div class="controls">
            <input type="number" class="form-control unicase-form-control text-input"   pattern="[0-9]"  onkeypress="return AllowOnlyNumbers(event);" maxlength="5" name="payout_amount1" id="payout_amount1" placeholder="Enter Bid Amount" value="<?php if($bid_1) { echo $bid_1; } else {echo '3';}?>" />
			</div>
			<label class="label_digit digit_img">2</label>
			<div class="controls">
            <input type="number" class="form-control unicase-form-control text-input"  pattern="[0-9]"  onkeypress="return AllowOnlyNumbers(event);" maxlength="5" name="payout_amount2" id="payout_amount2" placeholder="Enter Bid Amount" value="<?php if($bid_2) { echo $bid_2; } else {echo '6';}?>" />
			</div>
			<label class="label_digit digit_img">3</label>
			<div class="controls">
            <input type="number" class="form-control unicase-form-control text-input"  pattern="[0-9]"  onkeypress="return AllowOnlyNumbers(event);" maxlength="5" name="payout_amount3" id="payout_amount3" placeholder="Enter Bid Amount" value="<?php if($bid_3) { echo $bid_3; } else {echo '10';}?>" />
			</div>
			<label class="label_digit digit_img">4</label>
			<div class="controls">
            <input type="number" class="form-control unicase-form-control text-input"  pattern="[0-9]"  onkeypress="return AllowOnlyNumbers(event);" maxlength="5" name="payout_amount4" id="payout_amount4" placeholder="Enter Bid Amount" value="<?php if($bid_4) { echo $bid_4; } else {echo '15';}?>" />
			</div>
			<label class="label_digit digit_img">5</label>
			<div class="controls">
            <input type="number" class="form-control unicase-form-control text-input"  pattern="[0-9]"  onkeypress="return AllowOnlyNumbers(event);" maxlength="5" name="payout_amount5" id="payout_amount5" placeholder="Enter Bid Amount" value="<?php if($bid_5) { echo $bid_5; } else {echo '21';}?>" />
			</div>
			<label class="label_digit digit_img">6</label>
			<div class="controls">
            <input type="number" class="form-control unicase-form-control text-input"  pattern="[0-9]"  onkeypress="return AllowOnlyNumbers(event);" maxlength="5" name="payout_amount6" id="payout_amount6" placeholder="Enter Bid Amount" value="<?php if($bid_6) { echo $bid_6; } else {echo '28';}?>" />
			</div>
			<label class="label_digit digit_img">7</label>
			<div class="controls">
            <input type="number" class="form-control unicase-form-control text-input"  pattern="[0-9]"  onkeypress="return AllowOnlyNumbers(event);" maxlength="5" name="payout_amount7" id="payout_amount7" placeholder="Enter Bid Amount" value="<?php if($bid_7) { echo $bid_7; } else {echo '36';}?>" />
			</div>
			<label class="label_digit digit_img">8</label>
			<div class="controls">
            <input type="number" class="form-control unicase-form-control text-input"  pattern="[0-9]"  onkeypress="return AllowOnlyNumbers(event);" maxlength="5" name="payout_amount8" id="payout_amount8" placeholder="Enter Bid Amount" value="<?php if($bid_8) { echo $bid_8; } else {echo '45';}?>" />
			</div>
			<label class="label_digit digit_img">9</label>
			<div class="controls">
            <input type="number" class="form-control unicase-form-control text-input"  pattern="[0-9]"  onkeypress="return AllowOnlyNumbers(event);" maxlength="5" name="payout_amount9" id="payout_amount9" placeholder="Enter Bid Amount" value="<?php if($bid_9) { echo $bid_9; } else {echo '55';}?>" />
			</div>
			<label class="label_digit digit_img">10</label>
			<div class="controls">
            <input type="number" class="form-control unicase-form-control text-input"  pattern="[0-9]"  onkeypress="return AllowOnlyNumbers(event);" maxlength="5" name="payout_amount10" id="payout_amount10" placeholder="Enter Bid Amount" value="<?php if($bid_10) { echo $bid_10; } else {echo '63';}?>" />
			</div>
			<label class="label_digit digit_img">11</label>
			<div class="controls">
            <input type="number" class="form-control unicase-form-control text-input"  pattern="[0-9]"  onkeypress="return AllowOnlyNumbers(event);" maxlength="5" name="payout_amount11" id="payout_amount11" placeholder="Enter Bid Amount" value="<?php if($bid_11) { echo $bid_11; } else {echo '69';}?>" />
			</div>
			<label class="label_digit digit_img">12</label>
			<div class="controls">
            <input type="number" class="form-control unicase-form-control text-input"  pattern="[0-9]"  onkeypress="return AllowOnlyNumbers(event);" maxlength="5" name="payout_amount12" id="payout_amount12" placeholder="Enter Bid Amount" value="<?php if($bid_12) { echo $bid_12; } else {echo '73';}?>" />
			</div>
			<label class="label_digit digit_img">13</label>
			<div class="controls">
            <input type="number" class="form-control unicase-form-control text-input"  pattern="[0-9]"  onkeypress="return AllowOnlyNumbers(event);" maxlength="5" name="payout_amount13" id="payout_amount13" placeholder="Enter Bid Amount" value="<?php if($bid_13) { echo $bid_13; } else {echo '75';}?>" />
			</div>
			...
			<div class="controls">
            <input type="number" class="form-control unicase-form-control text-input"  pattern="[0-9]"  onkeypress="return AllowOnlyNumbers(event);" maxlength="5" name="payout_amount14" id="payout_amount14" placeholder="Enter Bid Amount" value="<?php if($bid_14) { echo $bid_14; } else {echo '75';}?>" />
			</div>
			<label class="label_digit digit_img">15</label>
			<div class="controls">
            <input type="number" class="form-control unicase-form-control text-input"  pattern="[0-9]"  onkeypress="return AllowOnlyNumbers(event);" maxlength="5" name="payout_amount15" id="payout_amount15" placeholder="Enter Bid Amount" value="<?php if($bid_15) { echo $bid_15; } else {echo '73';}?>" />
			</div>
			<label class="label_digit digit_img">16</label>
			<div class="controls">
            <input type="number" class="form-control unicase-form-control text-input"  pattern="[0-9]"  onkeypress="return AllowOnlyNumbers(event);" maxlength="5" name="payout_amount16" id="payout_amount16" placeholder="Enter Bid Amount" value="<?php if($bid_16) { echo $bid_16; } else {echo '69';}?>" />
			</div>
			<label class="label_digit digit_img">17</label>
			<div class="controls">
            <input type="number" class="form-control unicase-form-control text-input"  pattern="[0-9]"  onkeypress="return AllowOnlyNumbers(event);" maxlength="5" name="payout_amount17" id="payout_amount17" placeholder="Enter Bid Amount" value="<?php if($bid_17) { echo $bid_17; } else {echo '63';}?>" />
			</div>
			<label class="label_digit digit_img">18</label>
			<div class="controls">
            <input type="number" class="form-control unicase-form-control text-input"  pattern="[0-9]"  onkeypress="return AllowOnlyNumbers(event);" maxlength="5" name="payout_amount18" id="payout_amount18" placeholder="Enter Bid Amount" value="<?php if($bid_18) { echo $bid_18; } else {echo '55';}?>" />
			</div>
			<label class="label_digit digit_img">19</label>
			<div class="controls">
            <input type="number" class="form-control unicase-form-control text-input"  pattern="[0-9]"  onkeypress="return AllowOnlyNumbers(event);" maxlength="5" name="payout_amount19" id="payout_amount19" placeholder="Enter Bid Amount" value="<?php if($bid_19) { echo $bid_19; } else {echo '45';}?>" />
			</div>
			<label class="label_digit digit_img">20</label>
			<div class="controls">
            <input type="number" class="form-control unicase-form-control text-input"  pattern="[0-9]"  onkeypress="return AllowOnlyNumbers(event);" maxlength="5" name="payout_amount20" id="payout_amount20" placeholder="Enter Bid Amount" value="<?php if($bid_20) { echo $bid_20; } else {echo '36';}?>" />
			</div>
			<label class="label_digit digit_img">21</label>
			<div class="controls">
            <input type="number" class="form-control unicase-form-control text-input"  pattern="[0-9]"  onkeypress="return AllowOnlyNumbers(event);" maxlength="5" name="payout_amount21" id="payout_amount21" placeholder="Enter Bid Amount" value="<?php if($bid_21) { echo $bid_21; } else {echo '28';}?>" />
			</div>
			<label class="label_digit digit_img">22</label>
			<div class="controls">
            <input type="number" class="form-control unicase-form-control text-input"  pattern="[0-9]"  onkeypress="return AllowOnlyNumbers(event);" maxlength="5" name="payout_amount22" id="payout_amount22" placeholder="Enter Bid Amount" value="<?php if($bid_22) { echo $bid_22; } else {echo '21';}?>" />
			</div>
			<label class="label_digit digit_img">23</label>
			<div class="controls">
            <input type="number" class="form-control unicase-form-control text-input"  pattern="[0-9]"  onkeypress="return AllowOnlyNumbers(event);" maxlength="5" name="payout_amount23" id="payout_amount23" placeholder="Enter Bid Amount" value="<?php if($bid_23) { echo $bid_23; } else {echo '15';}?>" />
			</div>
			<label class="label_digit digit_img">24</label>
			<div class="controls">
            <input type="number" class="form-control unicase-form-control text-input"  pattern="[0-9]"  onkeypress="return AllowOnlyNumbers(event);" maxlength="5" name="payout_amount24" id="payout_amount24" placeholder="Enter Bid Amount" value="<?php if($bid_24) { echo $bid_24; } else {echo '10';}?>" />
			</div>
			<label class="label_digit digit_img">25</label>
			<div class="controls">
            <input type="number" class="form-control unicase-form-control text-input"  pattern="[0-9]"  onkeypress="return AllowOnlyNumbers(event);" maxlength="5" name="payout_amount25" id="payout_amount25" placeholder="Enter Bid Amount" value="<?php if($bid_25) { echo $bid_25; } else {echo '6';}?>" />
			</div>
			<label class="label_digit digit_img">26</label>
			<div class="controls">
            <input type="number" class="form-control unicase-form-control text-input"  pattern="[0-9]"  onkeypress="return AllowOnlyNumbers(event);" maxlength="5" name="payout_amount26" id="payout_amount26" placeholder="Enter Bid Amount" value="<?php if($bid_26) { echo $bid_26; } else {echo '3';}?>" />
			</div>
			<label class="label_digit digit_img">27</label>
			<div class="controls">
            <input type="number" class="form-control unicase-form-control text-input"  pattern="[0-9]"  onkeypress="return AllowOnlyNumbers(event);" maxlength="5" name="payout_amount27" id="payout_amount27" placeholder="Enter Bid Amount" value="<?php if($bid_27) { echo $bid_27; } else {echo '1';}?>" />
			</div>
