...
define('SITE_URL', 'http://localhost/gclive');
...
i.fa.fa-twitter,i.fa.fa-whatsapp,i.fa.fa-linkedin{color:#fff;width:30px;height:30px;line-height:30px;font-size: 16px;border-radius:50%;text-align:center;transition:0.5s all;-webkit-transition:0.5s all;
-moz-transition:0.5s all;-o-transition:0.5s all;-webkit-border-radius:50%;-moz-border-radius:50%;-o-border-radius:50%;-ms-border-radius:50%;-ms-transition:0.5s all;}
@media only screen and (max-width: 800px) {
.carousel-inner {height:20%;}
}
@media only screen and (max-width: 1100px) {
.carousel-inner {height:28%;}
}
span.act_price {text-decoration: line-through;color: #999;}
span.dis_price {margin-left: 15px;}
span#discount {margin-left: 10px;color: #e42c42;}
h4.p-b-7 {min-height: 50px;}
.btn-custom {color: #fff;background-color: #17A2B8;border-color: #17A2B8;line-height: 10px;padding: 7px; margin-left: 10px;}
</style>
			...
			<section class="slider_img">
				...
				<div class="col-md-12 text-center"><span style="color:#000">Nice To See You Back! Lets Play The Next Game & Redeem Gifts</span></div>
					...
					<?php $user_level = $user_obj-> get_level_point($uid); //echo '<pre>';print_r($user_level);?>
						<div class="row">
						<div class="col-md-2 col-md" style="margin-left: 4%;"><img src="images/badges1.png" style="width:60px;height:60px;margin-right:45%;display:none;" class="img1"></div>
						<div class="col-md-2 col-md" style="margin-left: 4%;"><img src="images/badges2.png" style="width:60px;height:60px;margin-right:45%;display:none;" class="img2"></div>
						<div class="col-md-2 col-md" style="margin-left: 4%;"><img src="images/badges3.png" style="width:60px;height:60px;margin-right:45%;display:none;" class="img3"></div>
						<div class="col-md-2 col-md" style="margin-left: 4%;"><img src="images/badges4.png" style="width:60px;height:60px;margin-right:45%;display:none;" class="img4"></div>
						<div class="col-md-2 col-md" style="margin-left: 0%;"><img src="images/badges5.png" style="width:60px;height:60px;margin-right:45%;display:none;" class="img5"></div>
						</div>								               
					</div>
				<div class="row">
				<div class="col-md-12 col-xs-12 col-sm-11 ulevel" > 
					...
					if($level_user >5 && $level_user <=10)
					{
					$level_image ='images2.png';
					}
					if($level_user >10 && $level_user <=15)
					{
					$level_image ='images3.png';
					}
					if($level_user >15 && $level_user <=20)
					{
				...
				<div class="col-md-6 col-xs-12 col-sm-6 text-right ulevel" >
				...
				?>
				<input type="text" value="<?php echo $ref_url;?>" id="ref_link" readonly><button onclick="myFunction()" class="btn btn-custom btn-anim">Copy</button>
				 </div>									
				</div>
				...
				<div class="col-xs-12 col-md-12 col-sm-12 ulevel">  
				Share Referal Code: <a href="https://www.facebook.com/sharer/sharer.php?u=<?php echo $ref_url;?>" onclick="javascript:window.open(this.href, '', 'menubar=no,toolbar=no,resizable=yes,scrollbars=yes,height=300,width=600');return false;" target="_blank" title="Share on Facebook"><i class="fa fa-facebook"></i></a>
	  ...
	  <div class="row">
		 <?php
			...
			while ($row = mysqli_fetch_array($result, MYSQLI_BOTH)) {
				...
				?>
		 <div class="col-sm-10 col-xs-6 col-md-3 Product text-center">
			<!-- Block3 -->
			<div class="block3">
...
<script>
//var users_points = document.getElementById("users_points").value;
var users_points = '<?php echo $user_points?>';
var user_levels_complete1 = '<?php echo $user_levels_complete1?>';
var user_levels_complete2 = '<?php echo $user_levels_complete2?>';
var user_levels_complete3 = '<?php echo $user_levels_complete3?>';
var user_levels_complete4 = '<?php echo $user_levels_complete4?>';
var user_levels_complete5 = '<?php echo $user_levels_complete5?>';
var user_levels_complete1pls = +user_levels_complete1+1;
var user_levels_complete2pls = +user_levels_complete2+1;
var user_levels_complete3pls = +user_levels_complete3+1;
var user_levels_complete4pls = +user_levels_complete4+1;
var user_levels_complete5pls = +user_levels_complete4+1;
//alert(users_points);
if (users_points >=0 && users_points<=user_levels_complete1){
	 ...
	 if (users_points >= user_levels_complete1pls && users_points<=user_levels_complete2) {
    ...
    if (users_points >= user_levels_complete2pls && users_points<=user_levels_complete3) {
   ...
   if (users_points >= user_levels_complete3pls && users_points<=user_levels_complete4) {
   ...
   if (users_points >= user_levels_complete4pls) {
...
<script type="text/javascript">
 ...
 $('.share-btnv').on( 'click', fb_share );
	...
	function fb_share() { 
			...
			method: 'feed',
			name: "GiftsCome",
			link: "http://giftscome.com.cp-28.hostgatorwebservers.com/index.php",
			picture: "http://giftscome.com.cp-28.hostgatorwebservers.com/images/logo.png",
			caption: "The world's most popular Game",
			actions: {"name":"Search", "link":"http://giftscome.com.cp-28.hostgatorwebservers.com/index.php"}
		},  function(response) {
