...
while($row=mysqli_fetch_array($ret))
	 ...
	 <div class="col-lg-10 col-sm-10">
		 ...
		 <div class="col-lg-3 col-sm-3"><?php echo $row['postingDate'];?></div>
     </div>
	...
	<div class="col-lg-10 col-sm-10">
		 ...
		 <div class="col-lg-3 col-sm-3"><?php echo $row['status'];?></div>
    </div>
	...
	<div class="col-lg-10 col-sm-10">
		 ...
		 <div class="col-lg-3 col-sm-3"><?php echo $row['remark'];?></div>
    </div>
