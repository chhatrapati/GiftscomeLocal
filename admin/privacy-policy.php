...
$sql=mysqli_query($con,"insert into tbl_privacy_policy(title,description) values('$title','$description')");
...
<html lang="en">
<head>
<title>Privacy Policy Content | Admin</title>
<meta charset="UTF-8" />
          ...
          <div class="widget-content nopadding panel-collapse collapse in" id="collapsetwo">
            ...
            <thead>
             ...
             <tbody>
								...
								<?php $query=mysqli_query($con,"select * from tbl_privacy_policy");
									$cnt=1;
									while($row=mysqli_fetch_array($query)) {?>																	
										<tr>
											...
											?>
				                          <img id="imgnotpopular<?php echo $row['id']; ?>" onclick="funisactive(<?php echo $row['id']; ?>,1,'tbl_privacy_policy');" src='images/off.png' width='60' <?php echo $stylenotpopular;?> />
				                          <img id="imgpopular<?php echo $row['id']; ?>" onclick="funisactive(<?php echo $row['id']; ?>,0,'tbl_privacy_policy');" src='images/on.png'  width='60' <?php echo $stylepopular;?> />
										  </td>
										  <td>
											<a href="edit-privacy-policy.php?id=<?php echo toPublicId($row['id']);?>" ><i class="fa fa-edit"></i></a>
