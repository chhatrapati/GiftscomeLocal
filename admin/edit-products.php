...
$sql=mysqli_query($con,"update  products set category='$category',productName='$productname',productPrice='$productprice',productDescription='$productdescription',gift_coins_price='$gift_coins_price',gift_coins_value='$gift_coins_value',validity_of_vip_package='$validity_of_vip_package' where id='$pid' ");
$_SESSION['msg']="Product Updated Successfully !!";

if($category=='7')
	{
		$sql_76=mysqli_query($con,"update package set package_name='$productname',package_price='$productprice',package_validity='$validity_of_vip_package',gift_coins='$gift_coins_value' where package_id='$pid' ");
  ...
  <div class="row-fluid">
    <div class="span11">
      <div class="widget-box">
		...
		<div class="controls">
		<input type="text"    name="gift_coins_value"  id="gift_coins_value" placeholder="Enter Gift Coins Value" value="<?php echo htmlentities($row['gift_coins_value']);?>" class="span8 tip">
		</div>
		</div>
		...
		<div class="controls">
		<input type="text"    name="validity_of_vip_package"  id="validity_of_vip_package" placeholder="Enter Gift Come Vip Days" value="<?php echo htmlentities($row['validity_of_vip_package']);?>" class="span8 tip">
		</div>
		</div>
		
		<div class="control-group">
		<label class="control-label" for="basicinput">Daily Vip Coins</label>
		<div class="controls">
		<input type="text"    name="daily_vip_coins"  id="daily_vip_coins" placeholder="Enter Daily Vip Coins" class="span8 tip" value="<?php echo htmlentities($row['daily_vip_coins']);?>">
		</div>
		</div>
