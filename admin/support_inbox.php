...
<div id="content-header">
  <div id="breadcrumb"> <a href="manage-users.php" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a> <a href="#" class="current">Support Email List</a> </div>
  <h1>Support Email List</h1>
</div>
    ...
    <div class="span11">
      <div class="widget-box">
		...
		<?php if(!empty($_SESSION['msg'])){?>
									...
									setTimeout(function () {
									   window.location.href= 'http://localhost/giftscome/admin/role_assign.php'; // the redirect goes here
									},1000); // 5 seconds
									</script>
									</div>
		<?php } ?>
