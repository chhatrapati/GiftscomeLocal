              ...
              <tbody>
									...
									{ ?>									
										<tr>
											...
											<td>   <a href="javascript:void(0);" onClick="popUpWindow('/admin/updateorder.php?oid=<?php echo htmlentities($row['id']);?>');" title="Update order"><i class="fa fa-edit"></i></a>
											</td>
											</tr>
