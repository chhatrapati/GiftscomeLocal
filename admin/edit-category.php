  ...
  <div class="row-fluid">
    <div class="span11">
      <div class="widget-box">
		...
		<div class="controls">
		<input type="text" placeholder="Enter category Name"  name="category" id="category" value="<?php echo  htmlentities($row['categoryName']);?>" class="span8 tip" required>
		</div>
		</div>
		...
		<div class="controls">
		<textarea class="span8" name="description" id="description" rows="5"><?php echo  htmlentities($row['categoryDescription']);?></textarea>
		</div>
		</div>
	    <?php } ?>	
