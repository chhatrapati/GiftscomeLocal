    ...
    <div class="span11">
	  ...
	  <?php if(!empty($_SESSION['msg'])){?>
       ...
       <div class="widget-content nopadding panel-collapse collapse" id="collapseOne">	
		...
		<div class="controls">
		<input type="text" placeholder="Enter category Name"  name="category" id="category" class="span8 tip" required>
		</div>
		</div>
								...
								<?php $query=mysqli_query($con,"select * from category");
									...
									while($row=mysqli_fetch_array($query)) {?>																	
										<tr>
											...
											// ?>
				                         <!-- <img id="imgnotpopular<?php //echo $row['id']; ?>" onclick="funisactive(<?php //echo $row['id']; ?>,1,'category');" src='images/off.png' width='60' <?php //echo $stylenotpopular;?> />
				                          <img id="imgpopular<?php //echo $row['id']; ?>" onclick="funisactive(<?php //echo $row['id']; ?>,0,'category');" src='images/on.png'  width='60' <?php //echo $stylepopular;?> />
										  </td> -->
										  <td>
											<a href="edit-category.php?id=<?php echo toPublicId($row['id']);?>" ><i class="fa fa-edit"></i></a>
											<a href="category.php?id=<?php echo toPublicId($row['id']);?>&del=delete" onClick="return confirm('Are you sure you want to delete?')"><i class="fa fa-trash-o"></i></a></td>
										</tr>
										<?php $cnt=$cnt+1; } ?>
