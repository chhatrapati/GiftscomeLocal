    ...
    <body>
        <div id="loginbox">
            ...
            <form id="loginform" class="form-vertical" method="post" action="">
				 ...
				 <h2 class="text-center"> WELCOME TO USER LOGIN</h2>
				 <?php if (@$err !=''){?><div class="alert alert-error alert-block"><?php echo @$err;?></div><?php }?>
                <div class="control-group">
                    <div class="controls">
                        <div class="main_input_box">
                            <span class="add-on bg_lg"><i class="icon-user"> </i></span><input type="text" id="inputEmail" name="username" placeholder="Username" />
                        </div>
                    </div>
                </div>
                <div class="control-group">
                    <div class="controls">
                        <div class="main_input_box">
                            <span class="add-on bg_ly"><i class="icon-lock"></i></span><input type="password" id="inputPassword" name="password" placeholder="Password" />
                        </div>
                    </div>
                </div>
