  ...
  <div class="container-fluid">
    <div class="quick-actions_homepage">
      <ul class="quick-actions">
		...
		<li class="bg_lb"> <a href="support_us.php"> <i class="icon-dashboard"></i> <span class="label label-important"></span> Ticket Management </a> </li>
        ...
        <li class="bg_ls"> <a href="manage_games.php"> <i class="icon-gift"></i> Game Management</a> </li>
