...
$sql=mysqli_query($con, "update tbl_privacy_policy set title='$title',description='$description' where id='$id'");
    ...
    <div class="span12">
      <div class="widget-box">
       ...
       <div class="widget-content nopadding">
		...
		<?php
		$id=toInternalId($_GET['id']);
		$query=mysqli_query($con,"select * from tbl_privacy_policy where id='$id'");
