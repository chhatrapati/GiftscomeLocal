...
<div class="panel panel-default checkout-step-02">
	...
	<div id="collapseOne" class="panel-collapse collapse in">
   	...
   	<thead>
						<tr>
							<th class="gz_r">#</th>
							<th class="gz_r">Game Name</th>
							<th class="gz_r">Date</th>
							<th class="gz_r">Winning no</th>
							<th class="gz_r">Total Bids</th>
							<th class="gz_r">Total Coins Won</th>	
						</tr>
					</thead>
					<tbody class="text-left">
						...
						while($res=mysqli_fetch_array($data)) {
								...
								if($game_start_time>$currentTime){
								...
								<td class="t_gz_f"><?php $create_date = $game_start_time; echo date('d-M-y',strtotime($create_date));?></td>
								<td class="t_gz_f">
								<?php if($winn_no==''){?>
