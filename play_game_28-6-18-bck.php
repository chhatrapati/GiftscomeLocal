...
<?php } else { ?>
 ...
 <div class="row">
		        <div class="col-lg-8 col-sm-8 col-md-8 text-left Medi">
				...
				<div class="col-lg-4 col-sm-4 col-md-4 text-left"> 
					...
					<div class="text-center">
						<label style="padding-top:7px; color:#fff;margin-left: 12%;">Previous Bet :</label><input type="text" class="width-dynamic proba dva text-center" min="0" name="" id="prev_bets" value="<?php echo $total_bets;?>" style="align-self:center;min-width: 100px; max-width: 500px; margin-left:10px;" disabled>
						<label style="padding-top:7px; color:#fff;">Current Bet :</label><input type="text" class="width-dynamic proba dva text-center" min="0" name="total_bids_" id="total_bids" value="" style="align-self:center;min-width: 100px; max-width: 500px; margin-left:10px;" disabled>
						<label style="padding-top:7px; color:#fff;margin-left: 35%;">Remaining Coin Balance :</label><input type="text" class="width-dynamic proba dva text-center" min="0" name="gift_coins" id="gift_coins" value="<?php echo $_SESSION['gift_coins'];?>" style="align-self:center;min-width: 100px; max-width: 500px; margin-left:10px;" disabled>
