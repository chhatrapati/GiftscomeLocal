...
<?php //require_once('templates/datatable_css.php');?>
	...
	<link rel="stylesheet" href="css/game-zone.css" />
</head>
   		...
   		<thead class="u_g_h">						
					...
					<tbody class="text-left">
						...
						while($res=mysqli_fetch_array($data)) {
								...
								<td class="t_gz_f">
								<?php echo date('d-M-y h:i',strtotime($dateInLocal));?></td>
								<td class="t_gz_f">
							     --
								</td>
						...
						<?php }  if($game_status==1){
								...
								<td class="t_gz_c"><?php echo date('d-M-y h:i',strtotime($dateInLocal));?></td>
								<td class="t_gz_c">--</td>
						...
						<?php }  if($game_status==3){ ?>	
							...
							<tr>
								...
								<td class="t_gz"><?php echo date('d-M-y h:i',strtotime($dateInLocal));?></td>
								<td class="t_gz">
								<?php if($winno==''){?>
								<?php } else {?>
								<?php echo $winno;?>
