...
{
	echo 'erwer';
	echo $game_time=$_POST['game_time'];
	$sql=mysqli_query($con, "update tbl_game set game_start_time='$game_time' where id='17'");
...
<body class="animsition">
	...
	<div class="" style="padding-bottom: 10px;">
		<div class="row col-lg-12" > 
				<div class="col-lg-6">
					<div class="row text-center" >Quick Selection</div>
					<div class="row">
						<div class="col-lg-3"><label class="radio-inline"><input type="radio" name="add_option" value="ALL" checked="checked">All</label>
				...
				<div class="col-lg-4 text-center">
					<div class="row  text-center">Action</div>
					<div class="row">
						<button type="button" id="clear" class="btn btn-warning">Clear All</button>
						<button type="button" id="subbtn" class="btn btn-success" style="margin-left: 10px;">Submit</button>		
						<button type="button" name="" id="cnl_btn" class="btn btn-danger" value="cancel" onClick="window.location='game_zone.php';" style="margin-left: 10px;">Cancel</button>
					</div>
				</div>
				<div class="col-lg-2 text-center">
					<div class="row  text-center">Statics</div>
					<div class="row">
						<label>Coin Balance:</label><input type="text" class="width-dynamic proba dva" min="0" name="gift_coins" id="gift_coins" value="<?php echo $_SESSION['gift_coins'];?>" style="align-self:center;min-width: 100px; max-width: 500px; margin-left:10px;" disabled>
					<input type="hidden" id="rem_coins" value=""></div>
				</div>
		</div>
	</div>
