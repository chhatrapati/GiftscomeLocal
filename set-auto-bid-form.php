...
$no_of_games = $row_new['no_of_games'];
$game_id = $row_new['game_id'];
} ?>
<!-- Modal content-->
...
<h4 class="heading">Set your pre fixed bid amount for all games</h4>
...
<div class="col-lg-12 col-sm-12 col-md-12 text-left Medi" >
...
<div class="col-lg-12 col-sm-12 col-md-12 text-left Medi">
<div class="row">
<div class="col-lg-4 col-sm-4 col-md-4 text-center Medi">
<label class="label_digit">Enter number of games to auto bid</label>
<input type="number" style="width:46%;margin-left:26%;" class="form-control unicase-form-control text-input text-center"  min="0" pattern="[0-9]"  onkeypress="return AllowOnlyNumbers(event);" maxlength="5" name="no_of_games" id="no_of_games" placeholder="Enter number of games to auto bid" value="<?php if($no_of_games) { echo $no_of_games; } else {echo '0';}?>" />
</div>
<br/>
<div class="col-lg-4 col-sm-4 col-md-4 text-center Medi">
<label class="label_digit">Select Starting game number to pre bid</label>
<select name="game_id" id="game_id" style="padding:6px">

<?php
$games_result = mysqli_query($con,"select * from tbl_game WHERE game_status=0");
$i=0;
$games=explode(",",$game_id); //echo count($games);
$selected = $games;
while($game_name = mysqli_fetch_array($games_result)) {
	$isSelected = in_array($game_name["id"],$selected) ? "selected='selected'" : "";
?>
<option value="<?php echo $game_name["id"];?>" <?php echo $isSelected;?>><?php echo $game_name["game_name"];?></option>
<?php
$i++;
}
?>
...
<div class="col-lg-4 col-sm-4 col-md-4 text-left Medi">
 <label class="bid" style="padding-top:7px;padding-left:125px ">Total Bet :</label>
...
<label class="bid" style="padding-top:7px;padding-left:88px">Coin Balance :</label>
...
<script>
		 $("#sub_btn").click(function() {
			 ...
			 var no_of_games=  $("#no_of_games").val();
