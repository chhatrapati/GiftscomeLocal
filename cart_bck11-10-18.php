                                    ...
                                    if (!empty($_SESSION["shopping_cart"])) {
                                        ...
                                        foreach ($_SESSION["shopping_cart"] as $keys => $values) {
                                            ...
                                            <tr class="table-row">
                                                ...
                                                <td class="column-3"><img alt="Gift Coins" src="images/GiftCoin.png" class="top-icons" /><?php echo number_format($values["product_price"]); ?></td>  
                                                <td align="right"><?php $total_prc= $values["product_quantity"] * $values["product_price"]; echo number_format($total_prc); ?> <button name="delete" class="btn btn-danger btn-xs delete" id="<?php echo $values["product_id"]; ?>"><i class="fa fa-remove"></i></button></td>  
