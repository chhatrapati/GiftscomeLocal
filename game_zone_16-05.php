   		...
   		<thead class="u_g_h">						<tr>
					...
					<tbody class="text-left">
						...
						while($res=mysqli_fetch_array($data)) {
								...
								<td class="t_gz_f"><a target="_blank" href="play_game.php?game=<?php echo toPublicId($game_id);?>"><?php echo $game_name;?></a></td>
								...
								<td class="t_gz_f"><button  onClick="window.open('play_game.php?game=<?php echo toPublicId($game_id);?>','_blank');" style="color:red;">
						...
						<?php }  if($game_status==1){
								...
								<td class="t_gz_c"><button class="faa-pulse animated" onClick="window.open('play_game.php?game=<?php echo toPublicId($game_id);?>');">
...
$(document).ready(function() {
	var rowcount_old ='<?php echo $rowcount;?>';
	window.setInterval(function(){
	//alert(rowcount_old);
	$.ajax({  
		type: "POST",
		dataType: "text",
		url: "game_status_update.php",
		data: "name=" + name,  
		success: function(rr){
			var res = rr;
			if(rowcount_old < res)
