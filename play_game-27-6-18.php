		...
		<div class="panel-body">
			<div class="row">
			 ...
			 <?php if(!empty($_SESSION['msg'])){?>
				...
				<strong class="white">Total Bets:  <?php echo $total_bets;?></strong>
...
<?php } else { ?>
 ...
 <div class="row">
		        <div class="col-lg-9 col-sm-9 col-md-9 text-left Medi">
				 ...
				 <?php }?><button type="button" class="btn btn-warning bt" id="reverse_no">REVERSE BET</button></div>
				...
				<div class="col-lg-3 col-sm-3 col-md-3 text-left"> 
					...
					<div class="text-center">
						<label style="padding-top:7px; color:#fff;">Remaining Coin Balance :</label><input type="text" class="width-dynamic proba dva text-center" min="0" name="gift_coins" id="gift_coins" value="<?php echo $_SESSION['gift_coins'];?>" style="align-self:center;min-width: 100px; max-width: 500px; margin-left:10px;" disabled>
						<label style="padding-top:7px; color:#fff;margin-left: 32%;">Previous Bet :</label><input type="text" class="width-dynamic proba dva text-center" min="0" name="" id="prev_bets" value="<?php echo $total_bets;?>" style="align-self:center;min-width: 100px; max-width: 500px; margin-left:10px;" disabled>
						<label style="padding-top:7px; color:#fff;margin-left: 32%;">Current Bet :</label><input type="text" class="width-dynamic proba dva text-center" min="0" name="total_bids_" id="total_bids" value="" style="align-self:center;min-width: 100px; max-width: 500px; margin-left:10px;" disabled>
