		...
		<div class="panel-body">
			<div class="row">
			 ...
			 <?php if(!empty($_SESSION['msg'])){?>
				...
				<?php if($winning_no!=''){?>
				<strong style="color:#fff;width:100%;">Winning number of <?php echo $game_name;?> is: <?php echo $winn_no01;?> + <?php echo $winn_no02;?> + <?php echo $winn_no03;?> = <?php echo $winning_no;?><a href="users-game-history.php?game=<?php echo toPublicId($game_id);?>"> <b style="color:#88D5FF;">See Winners</b></a></strong><br/>
				<strong style="color:#fff;width:100%;">Total Bets:  <?php echo $total_bets;?></strong>
				<strong style="color:#fff;width:100%;">Total Coins Won:  <?php echo $total_coins_won;?></strong>
				<?php }?>
 ...
 <div class="row">
	...
	<div class="" style="padding-bottom: 3px;">
		...
		<div class="col-lg-7 Medi" style="padding-left:25px; ">
				...
				<label style="padding-top:7px; color:#fff;">Total Bets :</label><input type="text" class="width-dynamic proba dva text-center" min="0" name="total_bids_" id="total_bids" value="" style="align-self:center;min-width: 100px; max-width: 500px; margin-left:10px;" disabled>
