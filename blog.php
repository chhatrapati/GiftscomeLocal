				...
				<div class="col-md-8 col-lg-9 p-b-75">
					<div class="p-r-50 p-r-0-lg">
						...
						<div class="item-blog p-b-80">
							<a href="blog_detail.php?blog_id=<?php echo $blog_id;?>" class="item-blog-img pos-relative dis-block hov-img-zoom">
								<img src="images/blog-04.jpg" alt="IMG-BLOG">

								<span class="item-blog-date dis-block flex-c-m pos1 size17 bg4 s-text1">
								<?php
									$date = date('d F Y', strtotime($blog_date));
									echo $date;
									?>
							...
							<div class="item-blog-txt p-t-33">
								<h4 class="p-b-11">
									<a href="blog-detail.php?blog_id=<?php echo $blog_id;?>" class="m-text24">
										<?php $blog_title;?>
									</a>
								</h4>
								...
								<a href="blog_detail.php?blog_id=<?php echo $blog_id;?>" class="s-text20">
									Continue Reading
