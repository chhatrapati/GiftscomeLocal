...
echo $game_id=toInternalId($_GET['game']);
...
echo $game_name =$dataresult['game_name'];
						...
						<div class="col-lg-4" style="padding:0;">
							<form name="" method="post" action="" id="game_zone">
								<div class="block1 hov-img-zoom pos-relative m-b-30" >
									...
									<div>
										<ul class="heading py-1" style="border-right:0;">
											<?php
								...
								<div class="col-lg-4" style="padding:0;">
									<div class="block1 hov-img-zoom pos-relative m-b-30" >
										...
										<div>
											<ul class="heading py-1" style="border-left:0;">
								...
								<div class="col-lg-4">
								<div class="block1 hov-img-zoom pos-relative m-b-30" >
							<?php require_once('livechat/livechat.php');?>
																</div>
							</div>
						</div><!-- end of row -->
						</div>
