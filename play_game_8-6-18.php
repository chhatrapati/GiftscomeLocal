...
<?php } else { ?>
		...
		<div id="message"></div>
 <div class="row">
		        <div class="col-lg-10 col-sm-10 col-md-10 text-left">
				     <button class="btn-num-product-down btn btn-dng"><i class="fs-12 fa fa-minus" aria-hidden="true"></i></button>
					<input class="m-text18 t-center num-product" type="number" pattern="[0-9]" name="coin_add" id="coin_add" value="5" min="0" maxlength="5" style="border:1px solid #000 !important; height: 100% !important;">
														...
														<div class="col-lg-3 size8">
															<div class="center">
																...
																?>
																	...
																	<input class="size8 m-text18 t-center num-product" type="number" pattern="[0-9]" name="payout_amount<?php echo $row['payout_digit'];?>" id="payout_amount<?php echo $row['payout_digit'];?>" value="<?php echo $bid_amount_on_digit;?>" min="0" maxlength="5" onkeypress="return AllowOnlyNumbers(event);" onkeyup="todo()">
															...
															<div class="col-lg-3 size8">
																...
																?>
																	...
																	<div class="input-group button-main">
																		...
																		<input class="size8 m-text18 t-center num-product" type="number" pattern="[0-9]" name="payout_amount<?php echo $row['payout_digit'];?>" id="payout_amount<?php echo $row['payout_digit'];?>" min="0" maxlength="5" value="<?php echo $bid_amount_on_digit;?>" onkeypress="return AllowOnlyNumbers(event);" onkeyup="todo()" >
																		<button class="btn-num-product-up color1 flex-c-m size7 bg8 eff2 btn btn-suc" id="plus<?php echo $row['payout_digit'];?>" onclick="todo()">
																			<i class="fs-12 fa fa-plus" aria-hidden="true"></i>
																		</button>
																	</div>
