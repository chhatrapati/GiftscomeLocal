...
/*Select options for mobile view*/
$(function () {
        $("#mySelect").change(function () {
		   var selectedValue = $(this).find('option:selected').attr('name');
		   var btn= $("[id="+ selectedValue +"]");
		   btn.click();
            });
   $("#mySelect1").change(function () {
		   var selectedValue1 = $(this).find('option:selected').attr('name'); 
		   var btn1= $("[id="+ selectedValue1 +"]");
		   btn1.click();
            });
	todo_new();
    });