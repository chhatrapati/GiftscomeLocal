	...
	<table id="example" class="table table-striped"  cellspacing="0" width="100%">
   		...
   		<thead class="u_g_h">						<tr>
			...
			//echo 'Cureent time is: 	'.$currentTime = date( 'Y-m-d H:i:s', time () );
								...
								$toal_my_won = $payout_amount_onwin_no*$total_bids_onwin_no;
								/*Total Won on game*/
								...
								$toal_coins_won =$result_967['total_won_coins'];
								if($toal_coins_won=='')
								{
									$toal_coins_won ="0";
								}
								...
								if($game_status==0){ 
								$total_bids_on_future_game = $user_obj->get_total_noof_bids($game_id);
									if($total_bids_on_future_game=='')
									{
										$total_bids_on_future_game='0';
									}
									?>
								...
								<td class="t_gz_f"><?php echo $total_bids_on_future_game;?></td>
						...
						<?php }  if($game_status==1){
							...
							//$end_date = date('h:i:s',strtotime($end_date));
								...
								<td class="t_gz_c"><div id="total_bids"><?php echo $total_bids_on_current_game;?></div></td>
						...
						<?php }  if($game_status==3){ ?>	
							...
							<tr>
								...
								<td class="t_gz"><?php echo $toal_my_won;?></td>
