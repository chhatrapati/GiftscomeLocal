...
<body class="animsition" onLoad="start()" style="background:none;">
	<?php require_once('templates/header.php');?>
			...
			<section class="slider_img">
				...
				<div class="col-xs-12 col-md-12 col-sm-12" style="text-align:left;padding-left: 37px;">
				<?php 
				...
				<?php } else {?>
				<button type="button" id="" name="" class="btn btn-custom btn-anim" style="background-color: #808080;border-color: #808080;cursor:none;">Already Requested</button>
				<?php }}?>
				</div>
			...
			<div class="row">
				...
				<div class="col-sm-4 col-md-4 col-xs-12 block1 hov-img-zoom pos-relative m-b-30">
					...
					<div class="text_img">
						...
						<p>Share Is Care</p>
						<p><a href="coins-earning.php" style="color:white;text-decoration:underline">Discover Now</a></p>
					</div>
					<div class="block1-wrapbtn w-size2">	
					</div>
				</div>
