...
?>
<style>
#productContainer{font-family: Montserrat-Regular !important;}
.wrap-pic-w  {border: 1px solid skyblue; margin-top: 33px;padding: 2px;}
.bo-rad-23 { border-radius: 23px;width: 100%;height: 18%; margin-top:2%;}
.p-b-5 {text-align: center;}
input#search{display:none;}
input[type=text] { border: 2px solid red; border-radius: 4px;border: 1px solid #17a2b8!important;}
</style>
	<div class="col-md-12">
	 <div class="search-box">
        ...
        <div class="result"></div>
				...
				?>
				     ...
				     <?php 	}}} else{ echo 'You do not have friends ';} ?>
		             <div id="display"></div>
