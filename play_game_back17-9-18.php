...
//$query1 = "SELECT * FROM `test_userdata` where id = '".$sesId."'";
...
<?php require_once('set-auto-bid-form.php');?>
 ...
 <div class="row">
				...
				<div class="col-lg-2 col-sm-2 col-md-2 text-left"> 
					...
					<input type="hidden" id="final_bal" name="final_bal" value="">
							...
							<form name="" method="post" action="" id="game_zone">
								<div class="block1 hov-img-zoom pos-relative m-b-30" style="border-bottom:1px solid #08a6cc;">
									<h1 class="list-heading">
										<div class="row">
											<div class="col-xs-4 col-sm-4 col-md-4 col-lg-4">NUMBER</div>
											<!--<div class="col-xs-3 col-sm-3 col-md-3 col-lg-3">PREVIOUS PAYOUT <img src="images/logo-2.png" class="gift"></div>-->
											<div class="col-xs-4 col-sm-4 col-md-4 col-lg-4">PAYOUT RATE<img src="images/logo-2.png" class="gift"></div>
											<div class="col-xs-4 col-sm-4 col-md-4 col-lg-4">BET</div>
										</div>
									</h1>
									<div>
										<ul class="heading">
											...
											$no=0;while($row=mysqli_fetch_array($query)) {
												...
												*/
												...
												<li>
													<div class="row">
														<div class="col-xs-4 col-sm-4 col-md-4 col-lg-4 size8 gz_digit"><div class="back-img"><?php echo $row['payout_digit'];?></div></div>
											...
											<ul class="heading">
												...
												$no =14; while($row=mysqli_fetch_array($query)) { 
													...
													*/
													...
													<li>
														<div class="row">
															<div class="col-xs-4 col-sm-4 col-md-4 col-lg-4 size8"><div class="back-img"><?php echo $row['payout_digit'];?></div></div>
															<!--<div class="col-xs-3 col-sm-3 col-md-3 col-lg-3 size8">
																<div class="row">
