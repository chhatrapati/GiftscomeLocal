...
<link rel="stylesheet" href="admin/css/matrix-style.css" />
	...
	.right {background:#ffeaa7; color:#49E2FF;} 
	 ...
	 .table thead th {vertical-align: bottom; color: #000;font-size: 15px;padding: 6px;}
}
</style>
<style>
span.help-block {
                ...
                <table id="example" class="table data-table"  cellspacing="0" width="100%" >
                  <thead>
                    <tr>
				 	...
				 	<?php
					        $select_tic = mysqli_query($con,"SELECT ticket_id,`message`,`sub`,`created_at`,`user_id` FROM tickets where user_id = '104' ORDER BY ticket_id DESC;");
							$num=0;	
